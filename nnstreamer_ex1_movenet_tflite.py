...
class NNStreamerExample:
    ...
    def __init__(self, argv=None):
        ...
        # GObject.threads_init()    Ya no hace falta iniciar las hebras
    ...
    def run_example(self):
        ...
        self.pipeline = Gst.parse_launch(
            ...
            'videoconvert ! cairooverlay name= cairooverlay ! ximagesink name=img_tensor '
            't_raw. ! queue leaky=2 max-size-buffers=2 ! videoscale ! '
            'video/x-raw,width=256,height=256,format=RGB ! tensor_converter ! '
        ...
        # init pipeline
        strPipe = 'v4l2src name=cam_src ! videoconvert ! videoscale ! '
